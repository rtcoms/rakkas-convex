...
export declare function generateTokensForSession(ctx: MutationCtx, config: ConvexAuthConfig, userId: GenericId<"users">, sessionId: GenericId<"authSessions">): Promise<{
    token: string;
    refreshToken: string;
}>;
