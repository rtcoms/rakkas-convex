...
export declare function startPush(ctx: Context, url: string, request: StartPushRequest, verbose?: boolean): Promise<StartPushResponse>;
export declare function waitForSchema(ctx: Context, adminKey: string, url: string, startPush: StartPushResponse): Promise<any>;
export declare function finishPush(ctx: Context, adminKey: string, url: string, startPush: StartPushResponse): Promise<void>;
